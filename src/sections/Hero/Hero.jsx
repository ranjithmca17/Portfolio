...
import CV from "../../assets/S-Ranjith-cv_Mern_full-stack.pdf";
import Typewriter from "typewriter-effect";
import { useTheme } from '../../common/ThemeContext';
  ...
  return (
    <section id="hero" className={styles.container}>
      ...
      <div className={styles.info}>
        ...
        <div className={styles.socialLinks}>
          <a href="mailto:ranjithmca007@gmail.com" target="_blank" rel="noopener noreferrer">
            <SiGmail size={24} color={iconColor} />
          </a>
          <a href="https://github.com/ranjithmca17" target="_blank" rel="noopener noreferrer">
            <img src={githubIcon} alt="Github icon" />
          </a>
        ...
        <a href={CV} download className={styles.resumeButton}>
          <button>
            <FiDownload className={styles.downloadIcon} /> Resume
          </button>
        </a>
      </div>
    </section>
